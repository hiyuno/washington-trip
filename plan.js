...
window.WA_PLAN = function () {
  ...
  const P = (name, address, lat, lon, duration, notes = '') =>
    ({ id: uid(), name, address, lat, lon, duration, notes });
    ...
    days: [
      {
        ...
        stops: [
          ...
          P('Alki Beach', 'West Seattle, King County, WA', 47.58669, -122.39764, 150,
      ...
      },
      {
        ...
        stops: [
          ...
          P('Diablo Lake Overlook', 'North Cascades NP, Whatcom County, WA', 48.70981, -121.09715, 60,
      ...
      },
      {
        ...
        stops: [
          ...
          P('Hurricane Ridge', 'Olympic NP, Clallam County, WA', 47.96940, -123.49800, 120,
            'Carretera de 27 km desde Port Angeles, muy revirada. Comprueba que esté abierta antes de subir.'),
          P('Lake Crescent · Marymere Falls', 'Olympic NP, Clallam County, WA', 48.05030, -123.78834, 120,
      ...
      },
      {
        ...
        stops: [
          ...
          P('Hoh Rain Forest', 'Olympic NP, Jefferson County, WA', 47.86088, -123.93479, 150,
            'Hall of Mosses: 1,3 km en bucle, es lo que has visto en fotos. La carretera de acceso son 30 km sin cobertura.'),
          P('Rialto Beach', 'Olympic NP, Clallam County, WA', 47.92891, -124.64108, 120,
      ...
      },
      {
        ...
        stops: [
          P('Ruby Beach', 'Olympic NP, Jefferson County, WA', 47.71945, -124.41919, 75,
      ...
      },
      {
        ...
        stops: [
          ...
          P('Paradise · Mount Rainier', 'Mount Rainier NP, Pierce County, WA', 46.78600, -121.73500, 180,
